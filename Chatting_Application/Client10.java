...
public class Client10 extends JFrame implements ActionListener          // ActionListener from "awt.event"
{
    JTextField text;                                        // Globally declare text field(going to be used in ActionListener)
    static JPanel a1;
...
//********************************************* PROFILE IMAGE ***********************************************
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icons/client15.png"));
...
//********************************************* SEND BUTTON *************************************************
        ...
        t.setLocation(800, 50);                                  // need to change location as default location is top left
